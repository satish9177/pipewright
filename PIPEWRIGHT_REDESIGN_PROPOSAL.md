...
Vector memory (row 23), the retriever/FTS rung (row 19), Row 12 **PR-B/PR-C** (relevance ordering / omission), post-run hygiene (row 16), and the thread UI (rows 22b–22e) remain outside this window unless a later maintainer decision explicitly opens them. (Row 12 **PR-A** is complete; Row 11 is complete.)
