...
// #36C/#36F + Phase 2G PR-3: the evidence-chip vocabulary (ACTIVE_TEST_SUMMARY,
// ACTIVE_REVIEW_SUMMARY) and the buildEvidenceChips builder now live in
// @/utils/chunkEvidence (imported above) so the chunk panel and the cockpit-
// adjacent decision-evidence summary render identical chips from one source. The
// rendering here is unchanged — same function, same chunk data, same output.
